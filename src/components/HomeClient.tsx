...
const heroSlides = [
  {
    ...
    description: "Gravity-defying cantilever engineering. Each step floats in mid-air, anchored by hidden structural steel that makes the impossible look effortless.",
  ...
  },
  {
    ...
    description: "Sweeping arcs of hand-forged steel. Our signature curved staircases are engineered to flow, with every rail and baluster shaped to follow the curve perfectly.",
    link: "/portfolio/staircases",
  },
  {
    desktop: "/images/portfolio-organized/Railings/Exterior-Railing/king-iron-works-exterior-railing-1.jpg",
    mobile: "/images/portfolio-organized/Railings/Exterior-Railing/king-iron-works-exterior-railing-1.jpg",
    alt: "Custom exterior iron railing on brownstone steps",
    title: "Exterior Railings",
    description: "Built to endure New England weather and Florida sun. Custom exterior railings that add curb appeal and safety to any property — from brownstones to modern builds.",
    link: "/exterior-railing",
  },
  {
    desktop: "/images/portfolio-organized/Railings/Interior-Railing/king-iron-works-interior-railing-1.jpg",
    mobile: "/images/portfolio-organized/Railings/Interior-Railing/king-iron-works-interior-railing-1.jpg",
    alt: "Custom interior iron railing with ornamental details",
    title: "Interior Railings",
    description: "The details your guests notice first. Hand-forged interior railings in ornamental, modern, and transitional styles — each one custom-built for your space.",
  ...
  },
  {
    ...
    description: "Sculptural steel that spirals skyward. Space-saving and stunning — our spiral staircases turn tight footprints into architectural showpieces.",
    link: "/portfolio/staircases",
  },
  {
    desktop: "/images/portfolio-organized/Structural-Steel/king-iron-works-structural-steel-10.jpg",
    mobile: "/images/portfolio-organized/Structural-Steel/king-iron-works-structural-steel-10.jpg",
    alt: "Commercial structural steel fabrication and installation",
    title: "Structural Steel",
    description: "The backbone of buildings. Commercial-grade structural steel fabrication, erection, and welding for new construction, renovations, and emergency repairs.",
...
const featuredWork = [
  {
    image:
      "/images/portfolio-organized/Staircases/Grand-Ornamental/king-iron-works-staircase-grand-project2-hero.jpg",
  ...
  {
    image:
      "/images/portfolio-organized/Railings/Interior-Railing/king-iron-works-interior-railing-1.jpg",
  ...
  {
    image:
      "/images/portfolio-organized/Gates/king-iron-works-gate-ornamental-black-gold-scrollwork.jpg",
  ...
  {
    image:
      "/images/portfolio-organized/Fire-Escape/king-iron-works-fire-escape-website-VrmKyMuo.jpg",
  ...
  {
    image:
      "/images/portfolio-organized/Balcony/king-iron-works-balcony-ornamental-boston-brick.jpg",
  ...
  {
    image:
      "/images/portfolio-organized/Structural-Steel/king-iron-works-structural-steel-10.jpg",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Our staircases stop people mid-sentence — but that&apos;s just
              where we start. The same master craftsmen who forge luxury
              staircases also build the railings, gates, balconies, and fire
              escapes that protect and beautify properties across nine states. If
              it&apos;s steel, we make it extraordinary.
            </p>
          </div>
            ...
            {[
              {
                ...
                image:
                  "/images/portfolio-organized/Railings/Interior-Railing/king-iron-works-interior-railing-grid-pattern.jpg",
                link: "/interior-railing",
              },
              {
                title: "Exterior Railings",
                ...
                image:
                  "/images/portfolio-organized/Railings/Exterior-Railing/king-iron-works-exterior-railing-8.jpg",
                link: "/exterior-railing",
              },
              {
                title: "Gates",
                ...
                image:
                  "/images/portfolio-organized/Gates/king-iron-works-gate-21.jpg",
                link: "/gate",
              },
              {
                title: "Fire Escapes",
                ...
                image:
                  "/images/portfolio-organized/Fire-Escape/fire_escape_magazine_16x9.jpg",
                link: "/fire-escape",
              },
              {
                title: "Structural Steel",
                ...
                image:
                  "/images/portfolio-organized/Structural-Steel/king-iron-works-structural-steel-20.jpg",
                link: "/structural-steel",
              },
              {
                title: "More",
                ...
                image:
                  "/images/portfolio-organized/Shop-Process/king-iron-works-shop-interior-webp.webp",
                link: "/services",
              },
            ].map((item, i) => (
              <Link key={i} href={item.link}>
                <div className="group cursor-pointer relative overflow-hidden rounded-sm">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5">
                    <h3 className="text-display text-base sm:text-lg text-white mb-1">
                      {item.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-white/60 leading-snug mb-3 line-clamp-2">
                      {item.desc}
                    </p>
          ...
          <div className="text-center mt-12">
            <Link href="/services">
              <Button
                size="lg"
                variant="outline"
                className="border-border hover:border-accent hover:bg-accent hover:text-accent-foreground font-display font-bold"
              >
                View All Services
                <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
            ...
            {[
              {
                number: "20+",
                label: "Years",
                desc: "of expertise in custom ironwork",
              },
              {
                number: "9",
                label: "States",
                desc: "served across the East Coast",
              },
              {
                number: "100%",
                label: "In-House",
                desc: "fabrication in our Everett shop",
              },
              {
                number: "MA",
                label: "Licensed",
                desc: "fire escape installer & certified",
              },
            ].map((stat, i) => (
              <div key={i} className="text-center">
                ...
                <div className="text-sm font-display font-bold tracking-wider uppercase mb-2">
                  {stat.label}
                </div>
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              See how a pencil sketch on paper becomes a masterpiece in iron and
              gold. Follow the full journey — from first idea to final reveal.
            </p>
          </div>
            ...
            {[
              {
                ...
                image:
                  "/images/portfolio-organized/Staircases/Curved/Project 2/king-iron-works-staircase-curved-project1-hero.jpg",
              ...
              },
              {
                ...
                image:
                  "/images/portfolio-organized/Staircases/Curved/Project 1/king-iron-works-staircase-website-425.jpg",
              ...
              <Link key={i} href={project.link}>
                <div className="group cursor-pointer relative overflow-hidden rounded-sm">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-display text-xl sm:text-2xl text-white mb-2">
                      {project.title}
                    </h3>
              ...
              <Link key={i} href={work.link}>
                <div className="relative group overflow-hidden cursor-pointer">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                    <p className="text-xs text-accent font-bold tracking-wider uppercase mb-1">
                      {work.category}
                    </p>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-sidebar-foreground/60 mb-10 leading-relaxed">
              With our fabrication shop in Everett, MA and service teams across
              nine states, we bring master craftsmanship to your doorstep.
            </p>
            <Link href="/locations">
              <Button
                size="lg"
                className="bg-accent hover:bg-accent/90 text-accent-foreground font-display font-bold px-8"
              >
                Find Your Location
                <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
      ...
      <section className="py-24 lg:py-32 bg-accent">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-display text-3xl md:text-5xl text-accent-foreground mb-6">
              Ready to Start
              <br />
              Your Project?
            </h2>
            <p className="text-lg text-accent-foreground/70 mb-10 leading-relaxed">
              Free consultation and assessment. Tell us what you&apos;re
              dreaming of — we&apos;ll engineer and forge it into reality.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <PhoneLink tel={PHONE_NUMBERS.MAIN.tel}>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-accent-foreground/30 text-accent-foreground hover:bg-accent-foreground/10 font-display font-bold px-8 py-5"
                >
