...
export const metadata: Metadata = {
  title: "Services — Custom Ironwork, Fire Escapes, Structural Steel",
  description:
    "King Iron Works offers fire escape installation and repair, historic building restoration, custom railings, gates, fences, structural steel, and more across Massachusetts and Florida.",
  alternates: {
    canonical: "https://www.kingsironworks.com/services",
  },
  openGraph: {
    title: "Services — Custom Ironwork, Fire Escapes, Structural Steel",
    description:
      "King Iron Works offers fire escape installation and repair, historic building restoration, custom railings, gates, fences, structural steel, and more across Massachusetts and Florida.",
    url: "https://www.kingsironworks.com/services",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center bg-sidebar text-sidebar-foreground pt-4">
        ...
        <div className="container relative z-10">
          <p className="section-eyebrow mb-4" style={{ color: "var(--accent)" }}>What We Do</p>
          <h1 className="text-display text-4xl md:text-6xl mb-6">Our Services</h1>
      ...
      <section id="fire-escape" className="bg-card py-24">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <div className="inline-block px-3 py-1.5 bg-accent/10 text-accent text-xs font-display font-bold tracking-wider mb-4">
                LICENSED &amp; CERTIFIED
              </div>
              <h2 className="text-display text-3xl md:text-5xl mb-6">Fire Escape Services</h2>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/fire-escape">
                  <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground font-display font-bold">
                    Learn More
      ...
      <section id="historic" className="bg-secondary text-secondary-foreground py-24">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="inline-block px-3 py-1.5 bg-accent/20 text-accent text-xs font-display font-bold tracking-wider mb-4">
                ARTISAN CRAFTSMANSHIP
              </div>
              <h2 className="text-display text-3xl md:text-5xl mb-6">Historic Building Restoration</h2>
      ...
      {/* Custom Ironwork */}
      <section id="custom" className="bg-card py-24">
        <div className="container">
          <div className="text-center mb-16">
            <p className="section-eyebrow mb-4">Designed &amp; Fabricated In-House</p>
            <h2 className="text-display text-3xl md:text-5xl mb-6">Custom Ironwork</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <Link key={service.href} href={service.href}>
                <Card className="p-6 border border-border hover:border-accent transition-all cursor-pointer h-full group">
                  <h3 className="text-heading text-xl mb-3 group-hover:text-accent transition-colors">{service.title}</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                    {service.desc}
                  </p>
                  <span className="text-accent font-display font-bold text-sm flex items-center gap-1 group-hover:translate-x-1 transition-transform">
          ...
          <div className="text-center">
            <img
              ...
              className="w-full max-w-2xl mx-auto h-[600px] object-cover mb-8"
            />
            <Link href="/portfolio">
              <Button size="lg" variant="outline" className="border-border hover:border-accent hover:bg-accent hover:text-accent-foreground font-display font-bold">
      ...
      <section className="bg-accent text-accent-foreground py-24">
        <div className="container">
          <h2 className="text-display text-3xl md:text-5xl text-center mb-16">Our Process</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl font-display font-bold mb-4 opacity-30">01</div>
            ...
            <div className="text-center">
              <div className="text-5xl font-display font-bold mb-4 opacity-30">02</div>
            ...
            <div className="text-center">
              <div className="text-5xl font-display font-bold mb-4 opacity-30">03</div>
            ...
            <div className="text-center">
              <div className="text-5xl font-display font-bold mb-4 opacity-30">04</div>
              <h3 className="text-heading text-xl mb-3">Installation</h3>
              <p className="opacity-90">
      ...
      <section className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-display text-3xl md:text-5xl mb-6">Start Your Project Today</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <PhoneLink tel={PHONE_NUMBERS.MAIN.tel}>
                <Button size="lg" variant="outline" className="border-sidebar-foreground/30 text-sidebar-foreground hover:bg-sidebar-foreground/10 font-display font-bold px-8">
