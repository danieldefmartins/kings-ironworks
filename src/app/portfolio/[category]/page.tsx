...
const parentCategories = [
  { id: "staircases", label: "Staircases", children: ["curved-staircases", "curved-project-1", "curved-project-2", "floating-full", "floating-mono-stringer", "floating-dual-stringer", "floating-exterior-staircases", "spiral-interior", "spiral-exterior", "grand-ornamental"] },
