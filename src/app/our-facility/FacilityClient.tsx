...
const weldingMachines = [
  {
    ...
    description: "Our go-to for speed and versatility. MIG welders produce clean, strong welds on steel and aluminum with excellent control — perfect for railings, gates, and structural work where efficiency meets quality.",
  ...
  },
  {
    ...
    description: "The precision choice. TIG welding gives us pinpoint control for thin materials, ornamental details, and visible joints where aesthetics matter. The result is a flawless, polished weld with zero spatter.",
  ...
  },
  {
    ...
    description: "Built for heavy-duty structural work and on-site repairs. Stick welding penetrates deep into thick steel, making it essential for fire escapes, structural beams, and outdoor installations where strength is everything.",
  ...
  },
  {
    ...
    description: "High-deposition welding for large-scale projects. Flux-core combines the speed of MIG with the penetration of stick — ideal for structural steel, heavy gates, and commercial projects that need to move fast without compromising strength.",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center bg-sidebar text-sidebar-foreground overflow-hidden pt-4">
        <div className="absolute inset-0 z-0">
          <img src="/images/portfolio-organized/Shop-Process/king-iron-works-shop-interior-webp.webp" alt="Kings Iron Works fabrication facility in Everett, MA" className="w-full h-full object-cover opacity-40" />
        </div>
        <div className="container relative z-10">
          <div className="max-w-4xl">
            <div className="inline-block px-4 py-2 bg-accent text-accent-foreground text-sm font-display font-bold tracking-wider mb-6">OUR FABRICATION FACILITY</div>
            <h1 className="text-display text-3xl md:text-7xl lg:text-8xl mb-4 md:mb-6 leading-tight">STATE-OF-THE-ART SHOP. FLAWLESS RESULTS.</h1>
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <div className="flex items-center gap-2"><Factory className="w-5 h-5 text-accent" /><span>15,000 SQ FT FACILITY</span></div>
              <div className="flex items-center gap-2"><Paintbrush className="w-5 h-5 text-accent" /><span>IN-HOUSE POWDER COATING</span></div>
              <div className="flex items-center gap-2"><Clock className="w-5 h-5 text-accent" /><span>20+ YEARS</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-accent text-accent-foreground py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">WHY OUR FACILITY MATTERS</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">No outsourcing. Every cut, weld, grind, and paint job happens in our shop under our quality control.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">Enough space to handle large-scale commercial projects and multiple residential jobs simultaneously.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-accent-foreground/80">MIG, TIG, stick, and flux-core — we match the right process to your project for the best possible result.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">INSIDE OUR SHOP</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {facilityImages.map((image, index) => (
              <div key={index} className="aspect-square overflow-hidden border border-border hover:border-accent transition-colors">
      ...
      <section className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">PROFESSIONAL WELDING EQUIPMENT</h2>
                  ...
                  <div>
                    ...
                    <ul className="grid grid-cols-2 gap-2">
                      {machine.strengths.map((strength, i) => (
                        <li key={i} className="flex items-center gap-2 text-sm"><CheckCircle2 className="w-4 h-4 text-accent flex-shrink-0" /><span>{strength}</span></li>
                      ))}
                    </ul>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="inline-block px-4 py-2 bg-accent text-accent-foreground text-sm font-display font-bold tracking-wider mb-6">IN-HOUSE POWDER COATING</div>
                <h2 className="text-display text-4xl md:text-5xl mb-6">A PROFESSIONAL FINISH MAKES ALL THE DIFFERENCE</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="aspect-square overflow-hidden border border-border">
                  <img src="/images/portfolio-organized/Shop-Process/king-iron-works-shop-process-website-4.jpg" alt="Powder coating in our facility" className="w-full h-full object-cover" loading="lazy" />
                </div>
                <div className="aspect-square overflow-hidden border border-border">
                  <img src="/images/portfolio-organized/Shop-Process/king-iron-works-shop-process-website-5.jpg" alt="Professional powder coat finish" className="w-full h-full object-cover" loading="lazy" />
                </div>
                <div className="aspect-square overflow-hidden border border-border col-span-2">
                  <img src="/images/portfolio-organized/Shop-Process/king-iron-works-shop-branded-truck.jpg" alt="Finished powder coated ironwork" className="w-full h-full object-cover" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-accent text-accent-foreground py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-16">THE KINGS IRON WORKS DIFFERENCE</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8 border border-accent-foreground/20 bg-accent-foreground/10">
              <h3 className="text-heading text-2xl mb-4 flex items-center gap-3"><Award className="w-7 h-7" />Our Shop</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2"><CheckCircle2 className="w-5 h-5 flex-shrink-0" /><span>{item}</span></li>
                ))}
              </ul>
            </Card>
            <Card className="p-8 border border-accent-foreground/20 bg-accent-foreground/5 opacity-70">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2 text-accent-foreground/70"><span className="w-5 h-5 flex-shrink-0 text-center">&#x2715;</span><span>{item}</span></li>
                ))}
              </ul>
            </Card>
          </div>
      ...
      <section id="quote" className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-display text-4xl md:text-5xl mb-6">SEE THE DIFFERENCE FOR YOURSELF</h2>
            ...
            <div className="max-w-2xl mx-auto mt-8"><GHLFormPlaceholder service="Facility Tour / Quote" /></div>
