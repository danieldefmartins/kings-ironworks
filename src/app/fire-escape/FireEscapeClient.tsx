...
export default function FireEscapeClient() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[80vh] flex items-center bg-sidebar text-sidebar-foreground overflow-hidden pt-4">
        <div className="absolute inset-0 z-0">
          <img
            src="/images/portfolio-organized/Fire-Escape/king-iron-works-fire-escape-website-YgqFSong.jpg"
        ...
        <div className="container">
          ...
          <div className="max-w-2xl mx-auto bg-card text-card-foreground p-8 border border-accent/30 rounded-lg">
            ...
            <p className="text-lg italic mb-4 leading-relaxed">
              &ldquo;Our fire escape failed inspection and we needed emergency repairs. Kings came out same-day,
              completed the work, and got us certified within 48 hours. Lifesavers!&rdquo;
            </p>
