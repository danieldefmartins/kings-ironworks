...
export const metadata: Metadata = {
  title: "About King Iron Works — 20+ Years of Master Craftsmanship",
  description:
    "Learn about King Iron Works — 20+ years of custom ironwork, fire escape services, and historic restoration in Boston. 100% in-house fabrication in Everett, MA.",
  alternates: {
    canonical: "https://www.kingsironworks.com/about",
  },
  openGraph: {
    title: "About King Iron Works — 20+ Years of Master Craftsmanship",
    description:
      "Learn about King Iron Works — 20+ years of custom ironwork, fire escape services, and historic restoration in Boston. 100% in-house fabrication in Everett, MA.",
    url: "https://www.kingsironworks.com/about",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[60vh] flex items-center bg-sidebar text-sidebar-foreground pt-4">
        ...
        <div className="container relative z-10">
          <p className="section-eyebrow mb-4" style={{ color: "var(--accent)" }}>Our Story</p>
          <h1 className="text-display text-4xl md:text-6xl mb-6">About King Iron Works</h1>
      ...
      <section className="bg-card py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="inline-block px-3 py-1.5 bg-accent/10 text-accent text-xs font-display font-bold tracking-wider mb-6">
              SINCE 2004
            </div>
            <h2 className="text-display text-3xl md:text-5xl mb-8">Our Story</h2>
      ...
      <section className="bg-secondary text-secondary-foreground py-24">
        <div className="container">
          <h2 className="text-display text-3xl md:text-5xl text-center mb-16">Our Values</h2>

          {/* American Pride Banner */}
          <div className="max-w-4xl mx-auto mb-12 p-8 bg-accent/10 border border-accent/30 text-center">
            <h3 className="text-display text-2xl md:text-3xl mb-4">American Made, American Proud</h3>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <div className="flex items-center gap-2 px-4 py-2 bg-secondary border border-accent/30">
                <span className="font-display font-bold text-sm">10% Military Discount</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-secondary border border-accent/30">
                <span className="font-display font-bold text-sm">Veteran Owned &amp; Operated</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-secondary border border-accent/30">
                <span className="font-display font-bold text-sm">Supporting Our Troops</span>
              </div>
            </div>
          </div>
      ...
      <section className="bg-card py-24">
        <div className="container">
          <h2 className="text-display text-3xl md:text-5xl text-center mb-16">
            What Sets Us Apart
          </h2>
      ...
      <section className="bg-accent text-accent-foreground py-24">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-display font-bold mb-2">20+</div>
              <div className="text-lg">Years in Business</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-display font-bold mb-2">4</div>
              <div className="text-lg">Locations</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-display font-bold mb-2">1000+</div>
              <div className="text-lg">Projects Completed</div>
            </div>
            <div className="text-center">
              <div className="text-5xl lg:text-6xl font-display font-bold mb-2">100%</div>
      ...
      <section className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-display text-3xl md:text-5xl mb-6">Work With Us</h2>
