...
const services = [
  {
    ...
    description: "Driveway gates, garden gates, and iron fences — designed and hand-forged in our shop to your exact specifications.",
    features: ["Swing & sliding gates", "Driveway & pedestrian", "Ornamental designs", "Automated options"],
  },
  {
    icon: Columns3,
    title: "Railings (Interior & Exterior)",
    description: "From elegant staircase railings to code-compliant exterior railings, every piece is built to last and look stunning.",
    features: ["Staircase railings", "Porch & deck railings", "ADA compliant", "Custom balusters"],
  },
  {
    icon: Grid3X3,
    title: "Balconies & Balustrades",
    description: "Juliet balconies, full balcony railings, and decorative balustrades that add character and safety to any building.",
    features: ["Juliet balconies", "Full balcony systems", "Load-rated designs", "Historic reproductions"],
  },
  {
    icon: Shield,
    title: "Window Guards & Grilles",
    description: "Security window guards and decorative grilles that protect without sacrificing style. Code-compliant for residential and commercial.",
    features: ["Security-rated", "Fire code compliant", "Decorative options", "Quick-release models"],
  },
  {
    icon: Sparkles,
    title: "Spiral Staircases",
    description: "Show-stopping spiral staircases engineered for safety and built as functional art. Interior and exterior designs available.",
    features: ["Interior & exterior", "Custom diameters", "Code compliant", "Ornamental details"],
  },
  {
    icon: Hammer,
    title: "Decorative & Ornamental Work",
    description: "Scrollwork, finials, custom brackets, furniture, and artistic metalwork. If you can imagine it, we can forge it.",
    features: ["Hand-forged scrollwork", "Custom brackets", "Metal furniture", "Artistic commissions"],
  },
];

const processSteps = [
  { step: "01", title: "Free Consultation", description: "We visit your property, discuss your vision, take measurements, and provide expert recommendations — at no cost." },
  { step: "02", title: "Design & Quote", description: "You receive a detailed design proposal and transparent quote. No hidden fees, no surprises." },
  { step: "03", title: "Fabrication", description: "Your piece is hand-crafted in our 15,000 sq ft Everett, MA shop by our team of experienced ironworkers." },
  { step: "04", title: "Installation", description: "Our crew handles professional installation, cleanup, and a final walkthrough to make sure you're 100% satisfied." },
];

export default function CustomIronworkClient() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center bg-sidebar text-sidebar-foreground overflow-hidden pt-4">
        <div className="absolute inset-0 z-0">
          <img src="/images/portfolio-organized/Gates/king-iron-works-gate-custom-iron-webp.webp" alt="Custom ironwork built in our fabrication shop" className="w-full h-full object-cover opacity-40" />
        </div>
        <div className="container relative z-10">
          <div className="max-w-4xl">
            <div className="inline-block px-4 py-2 bg-accent text-accent-foreground text-sm font-display font-bold tracking-wider mb-6">CUSTOM IRONWORK SPECIALISTS</div>
            <h1 className="text-display text-3xl md:text-7xl lg:text-8xl mb-4 md:mb-6 leading-tight">CUSTOM IRONWORK BUILT IN OUR SHOP</h1>
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <div className="flex items-center gap-2"><Wrench className="w-5 h-5 text-accent" /><span>OWN FABRICATION SHOP</span></div>
      ...
      <section className="bg-accent text-accent-foreground py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">OUR RECENT WORK</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {portfolioImages.map((image, index) => (
              <div key={index} className="aspect-square overflow-hidden border border-accent-foreground/20 hover:border-accent-foreground/50 transition-colors">
          ...
          <div className="text-center mt-10">
            <Link href="/portfolio">
              <Button size="lg" variant="outline" className="border-accent-foreground/30 text-accent-foreground hover:bg-accent-foreground/10 text-lg px-8 py-6">
      ...
      <section className="bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">WHAT WE BUILD</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="p-8 border border-border hover:border-accent transition-colors">
                ...
                <Link href="#quote"><Button variant="outline" className="w-full">Get Quote <ArrowRight className="ml-2 w-4 h-4" /></Button></Link>
              </Card>
            ))}
          </div>
        </div>
      ...
      <section className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-16">WHY CHOOSE KINGS IRON WORKS</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="w-20 h-20 bg-accent/20 flex items-center justify-center mx-auto mb-6"><Wrench className="w-10 h-10 text-accent" /></div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-accent/20 flex items-center justify-center mx-auto mb-6"><Award className="w-10 h-10 text-accent" /></div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-accent/20 flex items-center justify-center mx-auto mb-6"><Shield className="w-10 h-10 text-accent" /></div>
      ...
      <section className="bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl text-center mb-4">HOW IT WORKS</h2>
          <p className="text-center text-lg text-muted-foreground mb-16 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((item, index) => (
              <div key={index} className="relative">
                <div className="text-7xl font-display font-black text-accent/20 mb-4">{item.step}</div>
      ...
      <section id="quote" className="bg-sidebar text-sidebar-foreground py-24">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-display text-4xl md:text-5xl mb-6">GET YOUR FREE CUSTOM IRONWORK QUOTE</h2>
            ...
            <div className="max-w-2xl mx-auto mt-8"><GHLFormPlaceholder service="Custom Ironwork" /></div>
