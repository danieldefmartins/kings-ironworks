...
export default function InteriorRailingClient() {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center bg-sidebar text-sidebar-foreground overflow-hidden pt-4">
        <div className="absolute inset-0 z-0">
          <img
            src="/images/portfolio-organized/Railings/Interior-Railing/king-iron-works-interior-railing-1.jpg"
      ...
      <section className="bg-accent text-accent-foreground py-20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-6xl font-display font-black mb-2">&infin;</div>
