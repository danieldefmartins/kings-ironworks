...
const FabSchema = z.object({
  ...
  bottomRailConstruction: z.enum(["", "between_posts", "custom"]).optional(),
  bottomRailEndGap: meas.optional(),
  picketEndGap: meas.optional(),
  picketSpacingDatum: z.enum(["", "max_clear_horizontal", "custom"]).optional(),
  corners: short,
