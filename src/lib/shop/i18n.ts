...
const STR: Record<Lang, Dict> = {
  en: {
    ...
    invg_abrasive: "Discs & abrasives",
    invg_welding: "Welding",
    invg_fastener: "Fasteners",
    invg_finish: "Paint",
    invg_bit: "Drill bits",
    invg_ppe: "Safety",
    invg_supply: "Shop supplies",
    invg_tool: "Tools",
    invg_truck_stock: "Steel on the truck",
  ...
  pt: {
    ...
    invNone: "Nada aqui.",
    invg_low: "Acabando",
    invg_abrasive: "Discos e abrasivos",
    invg_welding: "Solda",
    invg_fastener: "Fixadores",
    invg_finish: "Tinta",
    invg_bit: "Brocas",
    invg_ppe: "Segurança",
    invg_supply: "Materiais de oficina",
    invg_tool: "Ferramentas",
    invg_truck_stock: "Aço no caminhão",
  ...
  es: {
    ...
    invg_abrasive: "Discos y abrasivos",
    invg_welding: "Soldadura",
    invg_fastener: "Sujetadores",
    invg_finish: "Pintura",
    invg_bit: "Brocas",
    invg_ppe: "Seguridad",
    invg_supply: "Suministros",
    invg_tool: "Herramientas",
    invg_truck_stock: "Acero en la camioneta",
