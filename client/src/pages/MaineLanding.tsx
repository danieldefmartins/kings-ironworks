...
/**
 * Maine Location Landing Page
 * SEO-optimized for Maine area searches
 */
export default function MaineLanding() {
  const services = [
    {
      title: "Fire Escape Services",
      description: "Licensed installation, repairs, and 5-year certifications for Maine properties",
      icon: Shield,
    },
    {
      title: "Coastal Ironwork",
      description: "Custom gates, railings, and decorative ironwork built to withstand Maine's coastal climate",
      icon: Award,
    },
    {
      title: "Historic Restoration",
      description: "Preserving Maine's architectural heritage with authentic ironwork restoration and custom fabrication",
      icon: Clock,
    },
  ];
  ...
  const benefits = [
    ...
    "Coastal and cold-weather resistant materials",
  ...
  return (
    <div className="min-h-screen">
      <LocationSEO location="maine" />
      {/* Hero Section */}
      <section
        className="relative min-h-[90vh] flex items-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=1600&h=1200&fit=crop')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING MAINE</span>
              </div>
            </div>

            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              MAINE'S TRUSTED IRONWORK SPECIALISTS
            </h1>

            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and historic restoration for Maine homes and businesses.
              Licensed, insured, and built to withstand Maine's harshest conditions.
            </p>
      ...
      <section className="diagonal-cut-top bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl mb-4 text-center">OUR MAINE SERVICES</h2>
          <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Specialized ironwork solutions designed for Maine's coastal and inland environments
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-display text-4xl md:text-5xl mb-6">
                WHY MAINE TRUSTS KING IRON GROUP
              </h2>
              <p className="text-xl mb-8">
                Bringing over 20 years of New England ironwork expertise to the Pine Tree State.
                Our work stands the test of time — from coastal salt air to heavy snow and ice.
              </p>
      ...
      <section className="diagonal-cut-top bg-accent text-accent-foreground py-24">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free consultation and quote for your Maine ironwork project.
