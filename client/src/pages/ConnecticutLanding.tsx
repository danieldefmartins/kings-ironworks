...
/**
 * Connecticut Location Landing Page
 * SEO-optimized for Connecticut area searches
 */
export default function ConnecticutLanding() {
  const services = [
    {
  ...
  return (
    <div className="min-h-screen">
      <LocationSEO location="connecticut" />
      {/* Hero Section */}
      <section
        className="relative min-h-[90vh] flex items-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://files.manuscdn.com/user_upload_by_module/session_file/310519663313028198/aoFXjvosIbfREama.JPG')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING CONNECTICUT</span>
              </div>
            </div>

            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              CONNECTICUT'S TRUSTED IRONWORK SPECIALISTS
            </h1>

            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and historic restoration for Connecticut homes and businesses.
              Licensed, insured, and crafted with New England precision.
            </p>
