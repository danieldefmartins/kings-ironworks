...
export default function PortsmouthLanding() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <CityHero cityName="Portsmouth" stateName="NH" />
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <h2 className="text-display text-3xl md:text-5xl mb-4">
              Custom Ironwork for Portsmouth
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-sidebar-foreground/60 mb-8">
                Based in Everett, MA, we serve all of New Hampshire with custom ironwork,
