  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1506966953602-c20cc11f75e3?w=1600&h=1200&fit=crop')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING MIAMI, FL</span>
              </div>
            </div>
            
            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              MIAMI'S PREMIER IRONWORK SPECIALISTS
            </h1>
            
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and structural steel for South Florida properties. 
              Hurricane-rated, licensed, and built to withstand Florida's toughest conditions.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={`tel:${PHONE_NUMBERS.MIAMI.tel}`}>
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 py-6 thick-border w-full sm:w-auto">
                  ...
                  CALL {PHONE_NUMBERS.MIAMI.display}
                </Button>
              </a>
              <Link href="/contact">
            ...
            <div className="flex flex-wrap gap-4 text-white/80">
              <div className="flex items-center gap-2">
                ...
                <span>FL Licensed Installer</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-accent" />
