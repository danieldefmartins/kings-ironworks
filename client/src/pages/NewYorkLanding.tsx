...
/**
 * New York Location Landing Page
 * SEO-optimized for New York area searches
 */
export default function NewYorkLanding() {
  const services = [
    {
      title: "Fire Escape Services",
      description: "Licensed installation, repairs, and certifications for New York City and statewide properties",
      icon: Shield,
    },
    {
      title: "Structural Steel",
      description: "Commercial and residential structural steel fabrication for New York's demanding building codes",
      icon: Award,
    },
    {
      title: "Building Restoration",
      description: "Historic building restoration, facade repair, and custom architectural metalwork across New York",
      icon: Clock,
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <LocationSEO location="new-york" />
      {/* Hero Section */}
      <section
        className="relative min-h-[90vh] flex items-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://files.manuscdn.com/user_upload_by_module/session_file/310519663313028198/VrmKyMuovdgoFRfz.JPG')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING NEW YORK</span>
              </div>
            </div>

            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              NEW YORK'S TRUSTED IRONWORK SPECIALISTS
            </h1>

            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and structural steel for New York properties.
              Licensed, insured, and built to meet the highest standards in the industry.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={`tel:${PHONE_NUMBERS.NEW_YORK.tel}`}>
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 py-6 thick-border w-full sm:w-auto">
                  ...
                  CALL {PHONE_NUMBERS.NEW_YORK.display}
                </Button>
              </a>
              <Link href="/contact">
      ...
      <section className="diagonal-cut-top bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl mb-4 text-center">OUR NEW YORK SERVICES</h2>
          <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Professional ironwork solutions designed for New York's unique building requirements
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-display text-4xl md:text-5xl mb-6">
                WHY NEW YORK TRUSTS KING IRON GROUP
              </h2>
              <p className="text-xl mb-8">
                With over 20 years of experience in the Northeast, we bring Boston-grade craftsmanship to New York.
                From Manhattan brownstones to upstate commercial projects, we deliver excellence on every job.
              </p>
      ...
      <section className="diagonal-cut-top bg-accent text-accent-foreground py-24">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free consultation and quote for your New York ironwork project.
            We serve NYC, Long Island, Westchester, and all of New York State.
          </p>
