...
/**
 * Rhode Island Location Landing Page
 * SEO-optimized for Rhode Island area searches
 */
export default function RhodeIslandLanding() {
  const services = [
    {
      title: "Fire Escape Services",
      description: "Licensed installation, repairs, and 5-year certifications for Rhode Island properties",
      icon: Shield,
    },
    {
      title: "Custom Ironwork",
      description: "Custom gates, railings, and decorative ironwork for Providence, Newport, and all of Rhode Island",
      icon: Award,
    },
    {
      title: "Historic Restoration",
      description: "Preserving Rhode Island's rich architectural heritage with authentic ironwork restoration",
      icon: Clock,
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <LocationSEO location="rhode-island" />
      {/* Hero Section */}
      <section
        className="relative min-h-[90vh] flex items-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/images/NgBghqHCKpNCJSJs.jpg')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING RHODE ISLAND</span>
              </div>
            </div>

            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              RHODE ISLAND'S PREMIER IRONWORK SPECIALISTS
            </h1>

            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and historic restoration for Rhode Island homes and businesses.
              Licensed, insured, and crafted to withstand coastal New England conditions.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={`tel:${PHONE_NUMBERS.RHODE_ISLAND.tel}`}>
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 py-6 thick-border w-full sm:w-auto">
                  ...
                  CALL {PHONE_NUMBERS.RHODE_ISLAND.display}
                </Button>
              </a>
              <Link href="/contact">
      ...
      <section className="diagonal-cut-top bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl mb-4 text-center">OUR RHODE ISLAND SERVICES</h2>
          <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Specialized ironwork solutions for the Ocean State's residential and commercial properties
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-display text-4xl md:text-5xl mb-6">
                WHY RHODE ISLAND TRUSTS KING IRON GROUP
              </h2>
              <p className="text-xl mb-8">
                For over 20 years, we've been trusted ironwork specialists across New England.
                From Providence's historic Federal Hill to Newport's iconic mansions, our work honors Rhode Island's heritage.
              </p>
      ...
      <section className="diagonal-cut-top bg-accent text-accent-foreground py-24">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free consultation and quote for your Rhode Island ironwork project.
            We serve Providence, Newport, Warwick, Cranston, and all of Rhode Island.
          </p>
