...
/**
 * New Hampshire Location Landing Page
 * SEO-optimized for New Hampshire area searches
 */
export default function NewHampshireLanding() {
  const services = [
    {
      title: "Fire Escape Services",
      description: "Licensed installation, repairs, and 5-year certifications for New Hampshire properties",
      icon: Shield,
    },
    {
      title: "Custom Ironwork",
      description: "Custom gates, railings, and decorative ironwork designed for New England's climate",
      icon: Award,
    },
    {
      title: "Structural Steel",
      description: "Commercial and residential structural steel fabrication and installation throughout New Hampshire",
      icon: Clock,
    },
  ];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={`tel:${PHONE_NUMBERS.NEW_HAMPSHIRE.tel}`}>
      ...
      <section className="diagonal-cut-top bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl mb-4 text-center">OUR NEW HAMPSHIRE SERVICES</h2>
          <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Specialized ironwork solutions built to handle New Hampshire's demanding climate
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-display text-4xl md:text-5xl mb-6">
                WHY NEW HAMPSHIRE TRUSTS KING IRON GROUP
              </h2>
              <p className="text-xl mb-8">
                Bringing over 20 years of New England ironwork expertise to the Granite State.
                Our work is built to last through harsh winters, heavy snow loads, and everything in between.
              </p>
      ...
      <section className="diagonal-cut-top bg-accent text-accent-foreground py-24">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free consultation and quote for your New Hampshire ironwork project.
            We serve the entire state from Manchester to the White Mountains.
          </p>
