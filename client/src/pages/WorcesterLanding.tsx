...
/**
 * Worcester Location Landing Page
 * SEO-optimized for Worcester, MA area searches
 */
export default function WorcesterLanding() {
  const services = [
    {
      title: "Fire Escape Services",
      description: "Licensed installation, repairs, and 5-year certifications for Worcester properties",
      icon: Shield,
    },
    {
      title: "Historic Restoration",
      description: "Preserving Worcester's architectural heritage with authentic ironwork restoration",
      icon: Award,
    },
    {
      title: "Custom Ironwork",
      description: "Gates, railings, stairs, and decorative ironwork for Central Massachusetts homes and businesses",
      icon: Clock,
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <LocationSEO location="worcester" />
      {/* Hero Section */}
      <section
        className="relative min-h-[90vh] flex items-center bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/images/portfolio-organized/Branding/king-iron-works-worcester-commercial-service-area.jpg')`,
        }}
      >
          ...
          <div className="max-w-3xl">
            <div className="inline-block bg-accent px-4 py-2 mb-6">
              <div className="flex items-center gap-2 text-accent-foreground">
                ...
                <span className="font-heading font-bold">SERVING WORCESTER, MA</span>
              </div>
            </div>
            
            <h1 className="text-display text-5xl md:text-7xl mb-6 text-white">
              WORCESTER'S PREMIER IRONWORK SPECIALISTS
            </h1>
            
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Custom ironwork, fire escape services, and historic restoration for Central Massachusetts. 
              Licensed, insured, and trusted by Worcester homeowners and businesses for over 20 years.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <PhoneLink tel={PHONE_NUMBERS.WORCESTER.tel}>
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground text-lg px-8 py-6 thick-border w-full sm:w-auto">
                  ...
                  CALL {PHONE_NUMBERS.WORCESTER.display}
                </Button>
              </PhoneLink>
              <Link href="/contact">
      ...
      <section className="diagonal-cut-top bg-card py-24">
        <div className="container">
          <h2 className="text-display text-4xl md:text-5xl mb-4 text-center">OUR WORCESTER SERVICES</h2>
          <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto">
            Specialized ironwork solutions for Central Massachusetts homes, businesses, and historic properties
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-display text-4xl md:text-5xl mb-6">
                WHY WORCESTER TRUSTS KINGS IRONWORKS
              </h2>
              <p className="text-xl mb-8">
                For over 20 years, we've been Central Massachusetts' trusted ironwork specialists. 
                From historic Main South triple-deckers to modern commercial projects, our craftsmanship stands the test of time.
              </p>
      ...
      <section className="diagonal-cut-top bg-accent text-accent-foreground py-24">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get a free consultation and quote for your Worcester ironwork project. 
            We serve all of Central Massachusetts.
          </p>
