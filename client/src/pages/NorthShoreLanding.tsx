...
export default function NorthShoreLanding() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <CityHero cityName="North Shore" stateName="MA" />
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <h2 className="text-display text-3xl md:text-5xl mb-4">
              Custom Ironwork for North Shore
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-display text-3xl md:text-4xl text-sidebar-foreground mb-6">
                Serving North Shore & Surrounding Areas
              </h2>
      ...
      <section className="py-20 bg-accent">
        <div className="container text-center">
          <h2 className="text-display text-3xl md:text-5xl text-accent-foreground mb-4">
            Ready to Start Your North Shore Project?
          </h2>
