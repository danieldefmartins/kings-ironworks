...
const projects: Record<string, ProjectData> = {
  ...
  "peacock-masterpiece": {
    ...
    galleryImages: [
      ...
      `${IMG}/Project 2/king-iron-works-staircase-curved-peacock-side.jpg`,
      ...
      `${IMG}/Project 2/king-iron-works-staircase-curved-scrollwork-closeup.jpg`,
      ...
      `${IMG}/Project 2/king-iron-works-staircase-curved-grand-overhead.jpg`,
      ...
      `${IMG}/Project 2/king-iron-works-staircase-curved-ornamental-project1.jpg`,
      `${IMG}/Project 2/king-iron-works-staircases-curved-project-1.jpg`,
