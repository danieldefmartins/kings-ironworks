 ...
 * Handrail Landing Page - High-converting, SEO-optimized
 * Focus: Pipe handrails, ADA-compliant railings, commercial & industrial installations
 */

export default function HandrailLanding() {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[85vh] flex items-center bg-sidebar text-sidebar-foreground overflow-hidden pt-4">
        <div className="absolute inset-0 z-0">
          <img
            src="/images/portfolio-organized/Railings/Small-Railing/king-iron-works-small-railing-3.jpg"
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-display text-3xl md:text-7xl lg:text-8xl mb-4 md:mb-6 leading-tight">
              PIPE HANDRAIL & RAILING INSTALLATION
            </h1>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: Accessibility,
                title: "ADA-Compliant Handrails",
                description: "Fully ADA-compliant handrails engineered to meet all accessibility requirements. Proper grip diameters, extensions, and mounting heights for any application.",
                features: ["1.25\"-2\" grip diameter", "Proper extensions", "Correct mounting height", "Non-slip surfaces"]
              },
              {
                icon: Building2,
                title: "Commercial Pipe Railings",
                description: "Heavy-duty pipe railing systems for commercial buildings, parking garages, loading docks, and public spaces. Built to withstand high traffic and heavy use.",
                features: ["Schedule 40 pipe", "Galvanized options", "High-traffic rated", "Code compliant"]
              },
              {
                icon: Wrench,
                title: "Industrial Handrails",
                description: "OSHA-compliant industrial handrails for factories, warehouses, and manufacturing facilities. Safety-first design with durable materials and finishes.",
                features: ["OSHA compliant", "Fall protection", "Chemical resistant", "Heavy-duty mounting"]
              },
              {
                icon: Shield,
                title: "Stairway Handrails",
                description: "Interior and exterior stairway handrails for residential and commercial properties. Custom profiles and finishes to match your building's style.",
                features: ["Interior & exterior", "Custom profiles", "Return ends", "Multi-story runs"]
              },
              {
                icon: Wrench,
                title: "Wall-Mounted Handrails",
                description: "Secure wall-mounted handrails for corridors, ramps, and stairways. Clean bracket designs with concealed hardware for a professional appearance.",
                features: ["Concealed brackets", "Adjustable mounts", "Multiple finishes", "Continuous runs"]
              },
              {
                icon: Wrench,
                title: "Handrail Repair & Replacement",
                description: "Restore loose, damaged, or non-compliant handrails. We assess, repair, or replace existing systems to bring them up to current code requirements.",
